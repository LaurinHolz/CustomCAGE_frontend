...
const ENTITIES = [
  ...
  { name: "ent6",    priority: 2, services: ["Brute"],                                       decoys: ["Femitter"] },
  { name: "ent7",    priority: 2, services: ["Brute"],                                       decoys: ["Femitter"] },
  ...
  { name: "user10",  priority: 1, services: ["Eternal","Keep"],                              decoys: ["Femitter","SSHD"] },
  { name: "user11",  priority: 1, services: ["Keep","HTTPSRFI","HTTPRFI","Haraka"],          decoys: ["Vsftpd","SSHD"] },
  { name: "user12",  priority: 1, services: ["Keep","HTTPSRFI","HTTPRFI","Haraka","SQL"],    decoys: ["Vsftpd"] },
];

const CONNECTED_HOSTS = [
  null,                                                        // def
  ["ent1","ent2","ent3","ent4","ent5","ent6","ent7"],          // ent0
  ["ent0","ent2","ent3","ent4","ent5","ent6","ent7"],          // ent1
  ["ent0","ent1","ent3","ent4","ent5","ent6","ent7"],          // ent2
  ["ent0","ent1","ent2","ent4","ent5","ent6","ent7"],          // ent3
  ["ent0","ent1","ent2","ent3","ent5","ent6","ent7"],          // ent4
  ["ent0","ent1","ent2","ent3","ent4","ent6","ent7"],          // ent5
  ["ent0","ent1","ent2","ent3","ent4","ent5","ent7"],          // ent6
  ["opserv"],                                                  // ent7 -> opserv (gateway)
  null,                                                        // ophost0
  null,                                                        // ophost1
  null,                                                        // ophost2
  null,                                                        // opserv (target)
