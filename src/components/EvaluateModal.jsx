...
const styles = {
  ...
  segment: { display: "flex", padding: 4, borderRadius: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" },
  segmentBtn: (active) => ({
  ...
  emptyState: { padding: "16px 14px", borderRadius: 12, background: "rgba(0,0,0,0.18)", border: "1px solid rgba(255,255,255,0.06)", color: TEXT_SECONDARY, fontSize: 12.5, textAlign: "center" },
  list: { maxHeight: 200, overflowY: "auto", display: "flex", flexDirection: "column", gap: 4, padding: 4, borderRadius: 12, background: "rgba(0,0,0,0.18)", border: "1px solid rgba(255,255,255,0.06)" },
  ...
  footer: { display: "flex", justifyContent: "flex-end", gap: 10, padding: "16px 24px", borderTop: "1px solid rgba(255,255,255,0.07)", background: "rgba(0,0,0,0.15)" },
  cancelBtn: { padding: "9px 16px", borderRadius: 9, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.04)", color: TEXT_PRIMARY, fontSize: 12.5, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" },
  runBtn: (disabled) => ({
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>Pick a checkpoint and an episode budget, then run a deterministic evaluation pass.</p>
          </div>
