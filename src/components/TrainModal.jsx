...
const styles = {
  ...
  segment: {
    ...
    background: "var(--surface-muted)", border: "1px solid var(--modal-border)",
  },
  segmentBtn: (active) => ({
  ...
  emptyState: {
    padding: "16px 14px", borderRadius: 12, background: "var(--surface-muted)",
    border: "1px solid var(--modal-border)", color: TEXT_SECONDARY,
